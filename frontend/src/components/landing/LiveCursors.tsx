...
const CURSORS = [
  {
    ...
    color: '#FFD600',
    textColor: '#0A0A0A',
    animName: 'cursor-rook',
    duration: '18s',
    keyframes: `@keyframes cursor-rook {
  ...
  },
  {
    ...
    color: '#FF6B35',
    textColor: '#FFFFFF',
    animName: 'cursor-mate',
    duration: '22s',
    keyframes: `@keyframes cursor-mate {
  ...
  },
  {
    ...
    color: '#4ADE80',
    textColor: '#0A0A0A',
    animName: 'cursor-gambit',
    duration: '26s',
    keyframes: `@keyframes cursor-gambit {
  ...
  },
  {
    ...
    color: '#60A5FA',
    textColor: '#0A0A0A',
    animName: 'cursor-arbiter',
    duration: '30s',
    keyframes: `@keyframes cursor-arbiter {
